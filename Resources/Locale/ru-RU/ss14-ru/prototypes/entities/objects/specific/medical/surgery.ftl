...
ent-Bonesetter = костный сеттер
    .desc = Используется для возвращения костей на место.
ent-BoneGel = бутылка костяного геля
    .desc = Бутылка костяного геля, которую часто приходится заправлять из специализированного автомата .
...
ent-EnergyCautery = энергетический прижигатель 
    .desc = Прижигатель с энергетическим наконечником, также может быть использован в качестве дрели в активном состоянии.
ent-EnergyScalpel = энергетический скальпель
    .desc = Скальпель с энергетическим лезвием, также может быть использован в качестве пилы в активном состоянии.
